...
NumberLightCurveParameters = 2*(NumberFrequencies + 1) + 2*(NumberFrequencies*NumberHarmonics) + 8 ! Number of light curve parameters in the input file
NumberAttributes = 2*NumberFrequencies + 2*NumberFrequencies*NumberHarmonics + 15 ! Number of attributes to be computed
